...
var PORT = 8080;
var messages = [];
app.use(express["static"](path.join(__dirname, "/public"))); //app.set("view engine", "hbs"); //hbs es lo mismo que poner handlebars pero para que no te tire error debes instalar npm i hbs, configuracion de ruta del hbs
